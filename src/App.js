...
function App() {
  ...
  return (
    <div class="chat-container bg-gradient-to-r from-indigo-500 to-purple-600  max-h-full rounded-xl shadow-md flex flex-col h-screen overflow-y-auto px-10">
      ...
      <div className='w-1/2 m-auto '>
        ...
        <div class="flex items-center justify-center gap-2 p-20 ">

          <input
            type="text"
            class="rounded-md px-10 py-2 bg-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            value={userInput}
